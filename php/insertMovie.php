...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $NombrePOST = $input['Nombre'] ?? '';
    $DirectorPOST = $input['Director'] ?? '';
    $DuracionPOST = $input['Duracion'] ?? '';
    $GeneroPOST = $input['Genero'] ?? '';
    $FechaLanzamientoPOST = $input['FechaLanzamiento'] ?? '';
    $ClasificacionIdPOST = $input['ClasificacionId'] ?? '';
    ...
    $data = [
        "Nombre" => $NombrePOST,
        "Director" => $DirectorPOST,
        "Duracion" => $DuracionPOST,
        "Genero" => $GeneroPOST,
        "FechaLanzamiento" => $FechaLanzamientoPOST,
        "ClasificacionId" => $ClasificacionIdPOST
    ];
